    ...
    >
      ...
      <div className="relative z-10 flex h-full flex-col items-center justify-between p-6 text-center md:p-10">
        ...
        <div className="flex flex-col items-center gap-2 text-white">
          ...
          <p className="text-[10px] font-medium tracking-[0.3em] uppercase opacity-80 md:text-xs">
            {proyecto.ubicacion}
          </p>
        </div>
        ...
        <Link
          ...
          className="rounded-full border border-white/30 bg-white/15 px-8 py-3 text-[10px] font-semibold tracking-[0.25em] text-white uppercase backdrop-blur-md transition-all duration-300 hover:bg-white/30 md:text-xs"
        >
          Ir al proyecto
        </Link>
      </div>
